      ...
      <div class="card mb-12 bg-light">
        ...
        <div class="card-body">
          <form wire:submit.prevent="save"> <!-- Note the use of .prevent -->
                    ...
                    <button type="button" wire:click="connection" class="btn btn-info">
                        Cek Connection
                    </button>
                    <button type="button" wire:click="cekcourse" class="btn btn-info">
                        Cek Course
                    </button>
                    <button type="button" wire:click="cekquiz" class="btn btn-info">
                        Cek Quiz
                    </button>
                </form>
