 ...
 * Original file: /npm/jsqr@1.0.1/dist/jsQR.js
 *
    ...
    return (function (o) {
                ...
                return (
                    (o.prototype.multiply = function (o, e) {
                        return 0 === o || 0 === e
                            ? 0
                            : this.expTable[
                                  (this.logTable[o] + this.logTable[e]) %
                                      (this.size - 1)
                              ];
                    }),
                    ...
                    return (
                        ...
                        (o.prototype.addOrSubtract = function (e) {
                            ...
                            r.length > c.length &&
                                ((r = (n = [c, r])[0]), (c = n[1]));
                            for (
                                var s = new Uint8ClampedArray(c.length),
                                    a = c.length - r.length,
                                    d = 0;
                                d < a;
                                d++
                            ...
                            for (d = a; d < c.length; d++)
                                s[d] = t.addOrSubtractGF(r[d - a], c[d]);
                            return new o(this.field, s);
                            var n;
                        }),
                        ...
                        (o.prototype.multiplyPoly = function (e) {
                            ...
                            for (
                                ...
                                for (var l = r[n], B = 0; B < a; B++)
                                    d[n + B] = t.addOrSubtractGF(
                                        d[n + B],
                                        this.field.multiply(l, s[B])
                                    );
        ...
        function (o, e, r) {
            ...
            var t = r(4),
                ...
                s = r(11),
                a = r(12);
            e.default = function (o, e, r) {
                var d = t.binarize(o, e, r),
                    n = a.locate(d);
                if (!n) return null;
                var l = s.extract(d, n),
                    B = c.decode(l.matrix);
                return B
                    ? {
                          ...
                          chunks: B.chunks,
                          location: {
                              topRightCorner: l.mappingFunction(n.dimension, 0),
                              topLeftCorner: l.mappingFunction(0, 0),
                              bottomRightCorner: l.mappingFunction(
                                  n.dimension,
                                  n.dimension
                              ),
                              bottomLeftCorner: l.mappingFunction(
                                  0,
                                  n.dimension
                              ),
        ...
        function (o, e, r) {
            ...
            e.binarize = function (o, e, r) {
                if (o.length !== e * r * 4)
                    throw new Error("Malformed data passed to binarizer.");
                for (var n = new d(e, r), l = 0; l < e; l++)
                    for (v = 0; v < r; v++) {
                        var B = o[4 * (v * e + l) + 0],
                            i = o[4 * (v * e + l) + 1],
                            k = o[4 * (v * e + l) + 2];
                        n.set(l, v, 0.2126 * B + 0.7152 * i + 0.0722 * k);
                    }
                for (
                    var u = Math.ceil(e / s),
                        C = Math.ceil(r / s),
                    ...
                    for (x = 0; x < u; x++) {
                        for (var w = 0, P = 1 / 0, h = 0, v = 0; v < s; v++)
                            for (l = 0; l < s; l++) {
                                var y = n.get(x * s + l, f * s + v);
                                (w += y),
                                    (P = Math.min(P, y)),
                                    (h = Math.max(h, y));
                            }
                        var b = w / Math.pow(s, 2);
                        if (h - P <= a && ((b = P / 2), f > 0 && x > 0)) {
                            var p =
                                (m.get(x, f - 1) +
                                    2 * m.get(x - 1, f) +
                                    m.get(x - 1, f - 1)) /
                ...
                for (var g = c.BitMatrix.createEmpty(e, r), f = 0; f < C; f++)
                    for (var x = 0; x < u; x++) {
                        for (
                            var M = t(x, 2, u - 3),
                                L = t(f, 2, C - 3),
                            ...
                            for (var O = -2; O <= 2; O++)
                                w += m.get(M + N, L + O);
                        for (var I = w / 25, l = 0; l < s; l++)
                            for (v = 0; v < s; v++) {
                                var S = n.get(x * s + l, f * s + v);
                                g.set(x * s + l, f * s + v, S <= I);
                            }
                    }
                return g;
            };
        ...
        function (o, e, r) {
                ...
                t.ecBlocks.forEach(function (o) {
                    for (var e = 0; e < o.numBlocks; e++)
                        c.push({
                            ...
                            (s +=
                                o.dataCodewordsPerBlock +
                                t.ecCodewordsPerBlock);
                }),
                    (o = o.slice(0, s));
                for (
                    var a = t.ecBlocks[0].dataCodewordsPerBlock, d = 0;
                    d < a;
                    d++
                )
                    for (var n = 0, l = c; n < l.length; n++) {
                        (C = l[n]).codewords.push(o.shift());
                    }
                if (t.ecBlocks.length > 1)
                    for (
                        var B = t.ecBlocks[0].numBlocks,
                            i = t.ecBlocks[1].numBlocks,
                            d = 0;
                        d < i;
                        d++
                    )
                        c[B + d].codewords.push(o.shift());
                for (; o.length > 0; )
                    for (var k = 0, u = c; k < u.length; k++) {
                        var C = u[k];
                        C.codewords.push(o.shift());
                    }
                return c;
            }
            function d(o) {
                var e = (function (o) {
                    var e = o.height,
                        r = Math.floor((e - 17) / 4);
                    if (r <= 6) return i.VERSIONS[r - 1];
                    for (var s = 0, a = 5; a >= 0; a--)
                        for (n = e - 9; n >= e - 11; n--) s = c(o.get(n, a), s);
                    for (var d = 0, n = 5; n >= 0; n--)
                        for (a = e - 9; a >= e - 11; a--) d = c(o.get(n, a), d);
                    for (
                        var l, B = 1 / 0, k = 0, u = i.VERSIONS;
                        k < u.length;
                        k++
                    ) {
                        var C = u[k];
                        if (C.infoBits === s || C.infoBits === d) return C;
                        var m = t(s, C.infoBits);
                        m < B && ((l = C), (B = m)),
                            (m = t(d, C.infoBits)) < B && ((l = C), (B = m));
                    }
                    return B <= 3 ? l : void 0;
                })(o);
                if (!e) return null;
                var r = (function (o) {
                    for (var e = 0, r = 0; r <= 8; r++)
                        6 !== r && (e = c(o.get(r, 8), e));
                    for (d = 7; d >= 0; d--) 6 !== d && (e = c(o.get(8, d), e));
                    for (var s = o.height, a = 0, d = s - 1; d >= s - 7; d--)
                        a = c(o.get(8, d), a);
                    for (r = s - 8; r < s; r++) a = c(o.get(r, 8), a);
                    for (
                        var n = 1 / 0, l = null, B = 0, i = k;
                        B < i.length;
                        B++
                    ) {
                        var u = i[B],
                        ...
                        var f = t(e, C);
                        f < n && ((l = m), (n = f)),
                            e !== a && (f = t(a, C)) < n && ((l = m), (n = f));
                    }
                    return n <= 3 ? l : null;
                })(o);
                if (!r) return null;
                for (
                    var d = a(s(o, e, r), e, r.errorCorrectionLevel),
                        n = d.reduce(function (o, e) {
                            return o + e.numDataCodewords;
                        }, 0),
                        u = new Uint8ClampedArray(n),
                        C = 0,
                        m = 0,
                        f = d;
                    m < f.length;
                    ...
                    var w = f[m],
                        P = B.decode(
                            w.codewords,
                            w.codewords.length - w.numDataCodewords
                        );
                    if (!P) return null;
                    for (var h = 0; h < w.numDataCodewords; h++) u[C++] = P[h];
                }
                try {
                    return l.decode(u, e.versionNumber);
                } catch (o) {
                    return null;
                }
            }
            ...
            var n = r(0),
                ...
                u = [
                    ...
                    function (o) {
                        return (
                            (Math.floor(o.y / 2) + Math.floor(o.x / 3)) % 2 == 0
                        );
                    },
                    function (o) {
        ...
        function (o, e, r) {
            ...
            e.decode = function (o, e) {
                for (
                    ...
                    var k = r.readBits(4);
                    if (k === B.Terminator) return i;
                    if (k === B.Numeric) {
                        var u = t(r, l);
                        (i.text += u.text),
                            (w = i.bytes).push.apply(w, u.bytes),
                            i.chunks.push({ type: d.Numeric, text: u.text });
                    } else if (k === B.Alphanumeric) {
                        var C = c(r, l);
                        (i.text += C.text),
                            (P = i.bytes).push.apply(P, C.bytes),
                            i.chunks.push({
                                type: d.Alphanumeric,
                                text: C.text,
                            });
                        ...
                        var m = s(r, l);
                        (i.text += m.text),
                            (h = i.bytes).push.apply(h, m.bytes),
                            i.chunks.push({
                                type: d.Byte,
                                bytes: m.bytes,
                                text: m.text,
                        ...
                        var f = a(r, l);
                        (i.text += f.text),
                            (v = i.bytes).push.apply(v, f.bytes),
                            i.chunks.push({
                                type: d.Kanji,
                                bytes: f.bytes,
                                text: f.text,
                    ...
                    (o.prototype.readBits = function (o) {
                        ...
                        if (o > 0) {
                            ...
                            if (o > 0) {
                                ...
                                (e =
                                    (e << o) |
                                    ((this.bytes[this.byteOffset] & c) >> s)),
                                    (this.bitOffset += o);
                            }
                        }
                        return e;
        ...
        function (o, e, r) {
            ...
            e.decode = function (o, e) {
                ...
                for (
                    ...
                    var B = a.evaluateAt(s.exp(l + s.generatorBase));
                    (d[d.length - 1 - l] = B), 0 !== B && (n = !0);
                }
                if (!n) return r;
                var i = new c.default(s, d),
                    k = (function (o, e, r, t) {
                        e.degree() < r.degree() &&
                            ((e = (w = [r, e])[0]), (r = w[1]));
                        for (
                            ...
                            var n = c,
                                l = a;
                            if (((c = s), (a = d), c.isZero())) return null;
                            s = n;
                            for (
                                var B = o.zero,
                                    i = c.getCoefficient(c.degree()),
                                    k = o.inverse(i);
                                ...
                                var u = s.degree() - c.degree(),
                                    C = o.multiply(
                                        s.getCoefficient(s.degree()),
                                        k
                                    );
                                (B = B.addOrSubtract(o.buildMonomial(u, C))),
                                    (s = s.addOrSubtract(
                                        c.multiplyByMonomial(u, C)
                                    ));
                            }
                            if (
                                ((d = B.multiplyPoly(a).addOrSubtract(l)),
                                s.degree() >= c.degree())
                            )
                                return null;
                        }
                        ...
                        if (0 === m) return null;
                        var f = o.inverse(m);
                        return [d.multiply(f), s.multiply(f)];
                        var w;
                    })(s, s.buildMonomial(e, 1), i, e);
                if (null === k) return null;
                var u = (function (o, e) {
                    var r = e.degree();
                    if (1 === r) return [e.getCoefficient(1)];
                    for (
                        var t = new Array(r), c = 0, s = 1;
                        s < o.size && c < r;
                        s++
                    )
                ...
                for (
                    var C = (function (o, e, r) {
                            for (
                                var c = r.length, s = new Array(c), a = 0;
                                a < c;
                                a++
                            ) {
                                for (
                                    var d = o.inverse(r[a]), n = 1, l = 0;
                                    l < c;
                                    l++
                                )
                                    a !== l &&
            ...
            e.extract = function (o, e) {
                for (
                    var r = (function (o, e, r, c) {
                        ...
                        a = c.BitMatrix.createEmpty(e.dimension, e.dimension),
                        d = function (o, e) {
                            var r = s.a13 * o + s.a23 * e + s.a33;
                            return {
                                x: (s.a11 * o + s.a21 * e + s.a31) / r,
                                y: (s.a12 * o + s.a22 * e + s.a32) / r,
                            };
                        },
                        n = 0;
                    n < e.dimension;
                    ...
                    for (var l = 0; l < e.dimension; l++) {
                        var B = d(l + 0.5, n + 0.5);
                        a.set(l, n, o.get(Math.floor(B.x), Math.floor(B.y)));
                    }
                return { matrix: a, mappingFunction: d };
            };
        },
        function (o, e, r) {
            "use strict";
            ...
            function c(o, e, r, t) {
                ...
                for (
                    ...
                    if (
                        r.get(h, v) !== f &&
                        ((f = !f), n.push({ x: h, y: v }), n.length === t + 1)
                    )
                        break;
                    if ((u += k) > 0) {
                        if (P === d) break;
                ...
                for (var y = [], b = 0; b < t; b++)
                    n[b] && n[b + 1] ? y.push(i(n[b], n[b + 1])) : y.push(0);
                return y;
            }
            function s(o, e, r, t) {
                var s = e.y - o.y,
                    a = e.x - o.x,
                    d = c(o, e, r, Math.ceil(t / 2)),
                    n = c(o, { x: o.x - a, y: o.y - s }, r, Math.ceil(t / 2)),
                    l = d.shift() + n.shift() - 1;
                return (B = n.concat(l)).concat.apply(B, d);
                var B;
            }
            function a(o, e) {
                var r = t(o) / t(e),
                ...
                return (
                    e.forEach(function (e, t) {
                        c += Math.pow(o[t] - e * r, 2);
                    }),
                    { averageSize: r, error: c }
                );
            }
            function d(o, e, r) {
                try {
                    var t = s(o, { x: -1, y: o.y }, r, e.length),
                        c = s(o, { x: o.x, y: -1 }, r, e.length),
                        d = s(
                            o,
                            {
                    ...
                    return (
                        u +
                        (Math.pow(l.averageSize - C, 2) +
                            Math.pow(B.averageSize - C, 2) +
                            Math.pow(i.averageSize - C, 2) +
            ...
            var n = 4,
                ...
                i = function (o, e) {
                    return Math.sqrt(
                        Math.pow(e.x - o.x, 2) + Math.pow(e.y - o.y, 2)
                    );
                };
            e.locate = function (o) {
                for (
                ...
                var C = e
                    ...
                    .map(function (e) {
                        var r =
                                (e.top.startX +
                                    ...
                                    e.bottom.endX) /
                                4,
                            c = (e.top.y + e.bottom.y + 1) / 2;
                        if (o.get(Math.round(r), Math.round(c))) {
                            var s = [
                    ...
                    .map(function (o, e, r) {
                        ...
                        var t = r
                            ...
                            .map(function (e) {
                                return {
                                    ...
                                    score:
                                        e.score +
                                        Math.pow(e.size - o.size, 2) / o.size,
                                    size: e.size,
                                };
                            })
                            .sort(function (o, e) {
                        ...
                        return { points: [o].concat(t.slice(0, 2)), score: c };
                    })
                    .filter(function (o) {
                        return !!o;
                    })
                ...
                var m = (function (o, e, r) {
                    ...
                    h = (function (o, e, r, c) {
                        var a =
                                (t(s(o, r, c, 5)) / 7 +
                                    ...
                                    t(s(e, o, c, 5)) / 7) /
                                4,
                            d = Math.round(i(o, e) / a),
                            n = Math.round(i(o, r) / a),
                            l = Math.floor((d + n) / 2) + 7;
                        switch (l % 4) {
                            case 0:
                                l++;
                                break;
                        ...
                        return { dimension: l, moduleSize: a };
                    })(w, f, P, o),
                    v = h.dimension,
                    y = h.moduleSize,
                    b = { x: f.x - w.x + P.x, y: f.y - w.y + P.y },
                    p = (i(w, P) + i(w, f)) / 2 / y,
                    g = 1 - 3 / p,
                    x = { x: w.x + g * (b.x - w.x), y: w.y + g * (b.y - w.y) },
                    M = c
                        .map(function (e) {
                            var r =
                                    (e.top.startX +
                                    ...
                                    4,
                                c = (e.top.y + e.bottom.y + 1) / 2;
                            if (o.get(Math.floor(r), Math.floor(c))) {
                                var s = [
                                    e.top.endX - e.top.startX,
                                    e.bottom.endX - e.bottom.startX,
                                    e.bottom.y - e.top.y + 1,
                    ...
                    L = p >= 15 && M.length ? M[0] : x;
                return {
                    alignmentPattern: { x: L.x, y: L.y },
                    bottomLeft: { x: P.x, y: P.y },
                    dimension: v,
                    topLeft: { x: w.x, y: w.y },
                    topRight: { x: f.x, y: f.y },
                };
            };
        },
    ]).default;
});
//# sourceMappingURL=/sm/fcefa56cc5ce92fd3003709f020fa4fdf5aeb5adaa12f8bd2042127950e8bd0f.map
